...
function App() {
  const [movies, setMovies] = useState([
    ...
    { id: 6, title: 'PrisonBreak', year: 2019, genre: 'Thriller', liked: false },
    { id: 7, title: 'Into the Badlands', year: 2019, genre: 'Thriller', liked: false },
    { id: 8, title: 'Night Agent', year: 2019, genre: 'Thriller', liked: false },
    { id: 9, title: 'Lucifer', year: 2019, genre: 'Thriller', liked: false },
    { id: 10, title: 'SuperGirl', year: 2019, genre: 'Thriller', liked: false },
  ]);
